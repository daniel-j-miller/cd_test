...
dat_base
```
The rows where `feature` was `NA` are not actually returned, instead a whole missing row is returned in there place. This is somewhat unexpected unless you know what is happening and it's probably unlikely to be the desired result.
